{{--
    Solutions index, redesigned (preview). Route: /solutions/preview. No-index.
    Replaces v2.pages.solutions once approved.
--}}
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('new-theme23/css/solutions-preview.css') }}?v={{ filemtime(public_path('new-theme23/css/solutions-preview.css')) }}">
...
@section('content')
    ...
    <div class="sx">
        ...
        <section class="sx-sec sx-sec--cream" style="padding-top:0">
            <div class="sx-in">
                <div class="sx-head">
        ...
        <section class="sx-sec sx-sec--white" style="padding-top:0">
            <div class="sx-in">
                <div class="sx-split">
                    <div>
