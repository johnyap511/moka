...
@push('styles')
    @if(request()->boolean('app') || request()->cookie('moka_app'))<style>.fix-header,.mk-footer,respond-io-widget{display:none !important}.acct-hero{padding-top:calc(48px + env(safe-area-inset-top))}</style>@endif {{-- app-mode --}}
