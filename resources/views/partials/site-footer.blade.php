...
.mk-footer .mk-bottom{display:grid;grid-template-columns:1fr auto;gap:40px;align-items:center;padding-top:32px;padding-right:110px}
...
.mk-footer .mk-social{display:flex;gap:12px;margin-top:26px}
...
@media (max-width:1024px){.mk-footer .mk-top{grid-template-columns:1fr 1fr;gap:36px 32px}.mk-footer .mk-bottom{grid-template-columns:1fr 1fr;padding-right:0}}
@media (max-width:640px){.mk-footer{padding:44px 20px 110px}.mk-footer .mk-top{grid-template-columns:1fr;gap:30px;padding-bottom:36px}.mk-footer .mk-bottom{grid-template-columns:1fr;gap:26px;padding-top:26px;padding-right:0}.mk-footer .mk-news{padding-right:84px}.mk-footer .mk-news-row{max-width:100%}.mk-footer .mk-primary a{font-size:19px}}
</style>
    ...
    <div class="mk-in">
        <div class="mk-top">
            ...
            <div>
                <h4>Solutions</h4>
                <ul class="mk-list">
                    <li><a href="/solutions/for-homeowners">For homeowners</a></li>
                    <li><a href="/solutions/for-property-investors">For property investors</a></li>
            ...
            <div class="mk-contact">
                ...
                <p><a href="https://share.google/aLqcDYMvPEQwUoiq7" target="_blank" rel="noopener">Find us on Google</a></p>
                ...
                <div class="mk-social">
                    ...
                    <a href="https://www.tiktok.com/@mokahomemy" target="_blank" rel="noopener" aria-label="TikTok"><svg viewBox="0 0 24 24"><path d="M16.6 5.8a4.3 4.3 0 0 1-1-.1 4.3 4.3 0 0 1-3.3-3.2V2h-3.1v13.6a2.6 2.6 0 1 1-1.8-2.5V9.9a5.7 5.7 0 1 0 4.9 5.7V9.1a7.4 7.4 0 0 0 4.3 1.4V7.4a4.3 4.3 0 0 1-0-1.6z"/></svg></a>
                </div>
            </div>
        </div>
        <div class="mk-bottom">
