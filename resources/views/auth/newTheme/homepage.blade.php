        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-4 mb-3">Don't have account <a href="/homepage#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#signupModal"> Sign Up </a></p>
                </div>
            </div>
        </div>
    </div>
...
<option value="263">Zimbabwe (+263)</option>                                </select>
                    ...
                    <p class="my-4">Already have an account <a href="/homepage#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#loninModal"> Log in </a>
                    </p>
...
<option value="263">Zimbabwe (+263)</option>                            </select>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="container d-flex flex-column flex-md-row align-items-center py-3">
                ...
                <div class="col-md-6 py-3 ps-md-4 ps-lg-5">
                    <img src="/new-theme23\images\Asset&#32;1.png" alt="" srcset="" class="w-100">
                </div>
            </div>
        </div>
    </div>
    <div class="container section-height my-5 py-5">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center">
            <div class="col-md-6 py-3 pe-md-4 pe-lg-5">
                <img src="/new-theme23\images\Asset&#32;2.png" alt="" srcset="" class="w-100">
            </div>
            <div class="col-md-6 py-3 ps-md-4 ps-lg-5 make-order-first">
                ...
                <p class="text-green-1">
                    Our tried and tested strategy can earn
                    you up to 100% more than just Airbnb or
                    traditional tenancies alone.
                </p>
            </div>
        </div>
    </div>
    <div class="bg-white section-height">
        <div class="container my-5 py-5">
            <div class="d-flex flex-column flex-md-row align-items-center">
                <div class="col-md-6 py-3 pe-md-4 pe-lg-5">
                    ...
                    <p class="text-green-1">
                        With our complete renovation services,
                        you'll enjoy a property that not only
                        looks fantastic but also commands
                ...
                <div class="col-md-6 py-3 ps-md-4 ps-lg-5">
                    <img src="/new-theme23\images\Asset&#32;48.png" alt="" srcset="" class="w-100">
                </div>
            </div>
        </div>
    </div>
        <div class="container section-height my-5 py-5">
            <div class="d-flex flex-column flex-md-row align-items-center">
                <div class="col-md-6 py-3 pe-md-4 pe-lg-5">
                    <img src="/new-theme23\images\Asset&#32;3.png" alt="" srcset="" class="w-100">
                </div>
                <div class="col-md-6 py-3 pe-md-4 pe-lg-5 make-order-first">
                    <h2 class="heading-orange-2 mb-4">
                        We Are Offering A Hybrid
                        Rental Solution
                    </h2>
                    <p class="text-green-1">
                        We have more rental opportunities and
                        we make your investment property more
                        profitable. Speak to us now!
                    </p>
                </div>
            </div>
        </div>
    <div class="bg-white section-height">
      <div class="container my-5 py-5">
        <div class="d-flex flex-column flex-md-row align-items-center">
            <div class="col-md-5 py-3 pe-md-4 pe-lg-6">
                <h2 class="heading-orange-2 mb-4">
                    We Provide Hassle
                    Free Solution
                </h2>
            ...
            <div class="col-md-6 py-3 ps-md-4 ps-lg-5">
                <img src="/new-theme23\images\Asset&#32;4.png" alt="" srcset="" class="w-100">
            </div>
        </div>
        <div class="d-flex flex-wrap orange-card-parent my-5">
            <div class="col-12 col-md-6 col-lg-3 p-3">
                <div class="orange-card p-4">
                    <img src="/new-theme23\images\Asset&#32;7.png" alt="" srcset="">
            ...
            <div class="col-12 col-md-6 col-lg-3 p-3">
                <div class="orange-card p-4">
                    <img src="/new-theme23\images\Asset&#32;8.png" alt="" srcset="">
                    <h3 class="heading-orange-3 my-3">Guest Hosting</h3>
                    <p class="text-green-2 m-0">
                        24-hour booking service
                        support & guest check-ins
                    </p>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3 p-3">
                <div class="orange-card p-4">
                    <img src="/new-theme23\images\Asset&#32;9.png" alt="" srcset="">
            ...
            <div class="col-12 col-md-6 col-lg-3 p-3">
                <div class="orange-card p-4">
                    <img src="/new-theme23\images\Asset&#32;10.png" alt="" srcset="">
        ...
        <div class="d-flex justify-content-center">
            <a href="/service"> <button class="primary-btn">Our Services</button></a>
        </div>
    </div>
</div>
    ...
    <div class="container section-height my-5 py-5">
        ...
        <div class="d-flex flex-column flex-md-row align-items-center mt-4">
            <div class="col-md-6 d-flex justify-content-center py-3">
                <img src="/new-theme23\images\Asset&#32;5.png" alt="" srcset="" class="w-50">
            </div>
            <div class="col-md-6 py-3">
                ...
                <ul class="smarter-management-ul">
                    <li class="my-4">
                        <img src="/new-theme23\images\Asset&#32;11.png" alt="">
    ...
    <div class="bg-white section-height">
        <div class="container my-5 py-5">
            ...
            <div class="d-flex flex-wrap orange-card-parent my-4">
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="orange-card p-4">
                        <img src="/new-theme23\images\Asset&#32;12.png" alt="" srcset="">
                ...
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="orange-card p-4">
                        <img src="/new-theme23\images\Asset&#32;13.png" alt="" srcset="">
                        <h3 class="heading-orange-3 my-3">Renovation</h3>
                        <p class="text-green-2 m-0">
                            Make over your home
                            with a purpose
                ...
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="orange-card p-4">
                        <img src="/new-theme23\images\Asset&#32;14.png" alt="" srcset="">
                ...
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="orange-card p-4">
                        <img src="/new-theme23\images\Asset&#32;15.png" alt="" srcset="">
    ...
    <div class="bottom-banner mt-5 py-5">
        <div class="container">
            ...
            <div class="d-flex justify-content-center mt-5">
                <a href="/">  <button class="white-btn">Get a quick estimate (Free)</button></a>
