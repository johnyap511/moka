...
@section('seo_title', 'Our Services | Airbnb Management, Renovation & Housekeeping | MOKA')
@section('seo_description', 'Complete short-stay management for Malaysian property owners: multi-platform listings, professional photography, listing creation, price optimisation, guest vetting, housekeeping and renovation.')

@section('content')
    <div class="service-banner-outer">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-4 mb-3">Don't have account <a href="/service#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#signupModal"> Sign Up </a></p>
                </div>
            </div>
        </div>
    </div>
...
<option value="263">Zimbabwe (+263)</option>                                </select>
                    ...
                    <p class="my-4">Already have an account <a href="/service#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#loninModal"> Log in </a>
                    </p>
...
<option value="263">Zimbabwe (+263)</option>                            </select>
...
</div>        <div data-aos="fadeInUp" class="service-banner" id="service_banner">
            <div class="container d-flex flex-column align-items-center justify-content-center py-3">
                <h1 class="heading-white-1 text-center mb-4">Rest easy with our complete service</h1>
                <div class="col-md-7">
                    <p class="text-white-1 text-center m-0">
                        We're the professional short-let management team who optimise
                        your pricing and occupancy while handling everything for you.
                        Listing your property on Airbnb, Booking.com and more!
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white">
        <div class="container d-flex flex-column flex-lg-row mb-5 py-3">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-center">
                <div class="col-lg-7 py-3">
                    ...
                    <p class="text-green-1">
                        With our complete renovation services, you'll enjoy a property that
                        not only looks fantastic but also commands a higher market price.
                    </p>
                    <div class="d-flex flex-wrap service-orange-card-parent my-4">
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                    <img src="{{ asset('new-theme23/images/Asset%2050.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Renovates for
                                    own stay</h3>
                                <p class="font-green fs_12 m-0">
                                    Discover over 30 designs
                                    that perfectly embody
                                    your style.
                                </p>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                <img src="{{ asset('new-theme23/images/Asset%2051.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Renovates for
                                    rental investmen</h3>
                                <p class="font-green fs_12 m-0">
                                    We thoughtfully curate
                                    captivating designs that
                                    enhance property value while
                        ...
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                <img src="{{ asset('new-theme23/images/Asset%2052.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Over 2,000
                                    designer homes,
                                    and growing strong</h3>
                                <p class="font-green fs_12 m-0">
                                    Whether in Cheras or Klang
                                    Valley, Malaysians can now
                                    realize their dream of living
                                    in a perfect home.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-start align-items-end">
                        <a href="/"> <button class="primary-btn-small fs_18">View our popular designs here</button></a>
                    </div>
                </div>
                <div class="col-lg-5 py-3 ps-md-4 ps-lg-5">
                    <img src="{{ asset('new-theme23/images/Asset%2049.png') }}" alt="" srcset="" data-aos="fade-left" class="w-100">
                </div>
            </div>
        </div>
       ...
       <div class="container my-5 py-5">
        <div class="d-flex flex-column flex-lg-row align-items-center">
            <div class="col-lg-5 py-3 pe-md-4 pe-lg-5">
                <img src="{{ asset('new-theme23/images/Asset%2040.png') }}" alt="" srcset="" data-aos="fade-right" class="w-100">
            </div>
            <div class="col-lg-7 py-3 make-order-lg-first">
                ...
                <p class="text-green-1">
                    We design and launch your rental listing. From the initial
                    creation to optimising revenue and occupancy rates. You
                    gain access to our industry leading smart-property
                    dashboard, where you can monitor and live-edit your
                    listings from one easy-to-use hub.
                </p>
                <div class="d-flex flex-wrap service-orange-card-parent my-4">
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2028.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Multi-Platform Listings</h3>
                            <p class="font-green fs_12 m-0">
                                Compile bookings from
                                multiple websites in
                                one calendar
                            </p>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2029.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Professional Photography</h3>
                            <p class="font-green fs_12 m-0">
                                We’ll offer you a professional
                                photo shoot to maximise your
                    ...
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2030.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Listing Creation</h3>
                            <p class="font-green fs_12 m-0">
                                We'll setup and write your
                    ...
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2031.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Price Optimisation</h3>
                            <p class="font-green fs_12 m-0">
                                Automatically maximise your
                                revenue during big events with
        ...
        <div class="container section-height my-5 py-5">
            <div class="d-flex flex-column flex-lg-row align-items-center">
                <div class="col-lg-7 py-3">
                    ...
                    <p class="text-green-1">
                        You don’t even need to interact with guests, we do it all for you.
                        From 24 hour check-in and Check-out, guest screening, damage
                    ...
                    <div class="d-flex flex-wrap service-orange-card-parent my-4">
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                    <img src="{{ asset('new-theme23/images/Asset%2032.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Guest Vetting</h3>
                                <p class="font-green fs_12 m-0">
                                    We screen all guests and
                                    built up our own database
                                    of good and bad guests.
                                </p>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                <img src="{{ asset('new-theme23/images/Asset%2033.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Guest Check-in</h3>
                                <p class="font-green fs_12 m-0">
                                    Smooth check-in
                                    experience with our free
                                    lockbox installation and
                                    24/7 guest support.
                                </p>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                <img src="{{ asset('new-theme23/images/Asset%2034.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Linen & Toiletries</h3>
                                <p class="font-green fs_12 m-0">
                                    We provide hotel quality
                                    linen and a high-quality
                                    laundry service.
                                </p>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 p-2">
                            <div class="service-orange-card py-3 px-2">
                                <span>
                                <img src="{{ asset('new-theme23/images/Asset%2035.png') }}" alt="" srcset="">
                                </span>
                                <h3 class="font-green font-bold fs_14 my-3">Guest
                                    Communication</h3>
                                <p class="font-green fs_12 m-0">
                                    Our teams are trained to
                                    deal with all questions and
                ...
                <div class="col-lg-5 py-3 ps-md-4 ps-lg-5">
                    <img src="{{ asset('new-theme23/images/Asset%2041.png') }}" alt="" srcset="" data-aos="fade-left" class="w-100">
                </div>
            </div>
        </div>
    <div class="bg-white section-height">
       <div class="container my-5 py-5">
          <div class="d-flex flex-column flex-lg-row align-items-center">
            <div class="col-lg-5 py-3 pe-md-4 pe-lg-5">
                <img src="{{ asset('new-theme23/images/Asset%2042.png') }}" alt="" srcset="" data-aos="fade-right" class="w-100">
            </div>
            <div class="col-lg-7 py-3 make-order-lg-first">
                <h2 class="heading-orange-2 mb-4">
                    Property Management
                ...
                <p class="text-green-1">
                    The powerful host dashboard, dedicated housekeeping app, a
                    custom-built property database and our expert team are some
                    of the elements that keep your property thriving.
                </p>
                <div class="d-flex flex-wrap service-orange-card-parent my-4">
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                               <span><img src="{{ asset('new-theme23/images/Asset%2036.png') }}" alt="" srcset=""></span>
                            <h3 class="font-green font-bold fs_14 my-3">Cleaning & Housekeeping</h3>
                            <p class="font-green fs_12 m-0">
                                Our own cleaning service ensure
                                every clean is done thoroughly
                                with guests in mind.
                            </p>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2037.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Property Maintenance</h3>
                            <p class="font-green fs_12 m-0">
                                We’re always on standby to
                                quickly resolve issues with
                    ...
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2038.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Property Insurance</h3>
                            <p class="font-green fs_12 m-0">
                                We’ll provide the insurance
                    ...
                    <div class="col-6 col-md-3 p-2">
                        <div class="service-orange-card py-3 px-2">
                            <span>
                            <img src="{{ asset('new-theme23/images/Asset%2039.png') }}" alt="" srcset="">
                            </span>
                            <h3 class="font-green font-bold fs_14 my-3">Host Dashboard</h3>
                            <p class="font-green fs_12 m-0">
                                Syncs your calendar between
                                multiple booking websites to
                                give you more control and see
                                who is staying.
                            </p>
                        </div>
                    </div>
       ...
       <div class="container section-height my-5 py-5">
            ...
            <div class="d-flex flex-column flex-md-row align-items-center mt-4">
                ...
                <div class="col-md-6 py-3">
                    <p class="text-green-1">
                        The hub. The HQ. The nexus. We’ve built a powerful
                        platform and put your home at the heart of it.
                    </p>
