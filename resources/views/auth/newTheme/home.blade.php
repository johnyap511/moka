        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-4 mb-3">Don't have account <a href="/#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#signupModal"> Sign Up </a></p>
                </div>
            </div>
        </div>
    </div>
...
<option value="263">Zimbabwe (+263)</option>                                </select>
                    ...
                    <p class="my-4">Already have an account <a href="/#" class="text-decoration-underline" data-bs-toggle="modal" data-bs-target="#loninModal"> Log in </a>
                    </p>
...
<option value="263">Zimbabwe (+263)</option>                            </select>
            ...
            <div data-aos="fadeInUp" class="container d-flex flex-column flex-md-row align-items-center py-3">
                <div class="col-md-6 py-3 pe-md-4 pe-lg-5">
                    ...
                    <div class="form-sec">
                        ...
                        <a href="https://wa.me/message/BXH725WGY3OSA1" target="_blank">
  ...
  <div class="bg-white-dark">
    ...
    <div class="container my-5 py-5">
        ...
        <img src="/new-theme23\images\assets&#32;8.png" alt="" class="mt-5 pt-3 w-100">
